...
<body>
    <div class="row">
        <div class="col s12 m6 l6 offset-m3 offset-l3 hoverable z-depth-2">
            <nav class="green darken-4 z-depth-2">
            ...
            <ul id="log-wrapper" class="collection hoverable z-depth-1">
            </ul>
            <form id="form-msg">
                <div row>
                    ...
                    <div class="input-field col m2 l2 hide-on-med-and-down">
                        <button type="submit" class="btn waves-effect green darken-4 z-depth-2">send</button>
                    </div>
                </div>
            </form>
        </div>
